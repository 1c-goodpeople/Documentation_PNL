...
В рабочем столе продукта реализована новая вкладка **«Поддержка»**. Это единая точка входа, объединяющая все справочные и контактные сервисы, связанные с сопровождением продукта.
...
4. При установленном режиме проектов «Расширенный» в проекте во вкладке «Смета» по расходам добавлены колонки (% НДС, НДС и Всего). Данные колонки отображаются только если установлен вариант учета НДС «НДС в сумме» или «НДС сверху» на вкладке «Основное» в проекте.

   ![](./reliz-1-49-0-8.png){width=2206px height=967px}

5. Доработан отчет «**План-факт»:Общие показатели»**. Теперь общие показатели по выводу НДС отображаются по умолчанию с учетом суммы НДС. Чтобы исключить НДС, необходимо установить отметку «Очищать от НДС».

   [image:./reliz-1-49-0-9.png:::0,0,100,100::square,89.0046,9.699,10.9954,8.0268,,top-left&square,30.4398,30.2676,10.0116,69.7324,,top-left:2223px:769px:center]
