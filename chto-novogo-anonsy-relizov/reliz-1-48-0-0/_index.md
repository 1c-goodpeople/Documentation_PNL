...
1. Добавлена возможность создать сложное условие применения, как в правилах ОПиУ.
   ...
   **Если у вас уже были созданы правила, то нужно будет запустить обработку «Настройки - Администрирование- Действия - Первичное заполнение данных правил ДДС».**
...
2. Изменена форма выбора подбора платежного календаря из платежей

   ![](./reliz-1-48-0-5.png){width=1681px height=496px}
