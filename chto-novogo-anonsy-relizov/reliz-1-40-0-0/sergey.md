...
#### Автоматическое распределение по фондам

1. Исправлена ошибка, когда при пересечении правил выбирались все одновременно. Теперь будет выбираться одно, наиболее подходящее правило.

   1. Если подходящих правил будет несколько, то будет выбрано одно случайное
