...
1. В варианте отчета P&L: План-Факт добавлен отбор по версии плана
   ...
   ![](./reliz-1-43-0.png){width=2134px height=940px}
...
1. Добавлен отбор по физическому лицу
   ...
   [image:./reliz-1-2.png:::0,0,100,100::square,77.8356,74.4817,22.1644,25.5183,,top-left:2143px:777px:center]
...
1. Исправлена ошибка при использовании произвольных колонок
   ...
   ![](./reliz-1-43-0-2.png){width=1150px height=199px}
...
1. При создании операции по кошельку на основании управленческой ведомости, если заполнить физическое лицо, то движения по пройдут только по указанному физическому лицу. Соответственно задолженность по заработной плате закроется только по данному сотруднику.
   ...
   ![](./reliz-1-43-0-3.png){width=2121px height=982px}
...
5. Для Бухгалтерии предприятия. Документ «Отражение зарплаты». Добавлено создание на основании отпуска.
   ...
   ![](./reliz-1-43-0-4.png){width=1888px height=301px}
...
1. В смету проектов добавлена колонка «Содержание». Она заполняется из номенклатуры с типом Услуга и передается в документ Реализация
   ...
   ![](./reliz-1-43-0-5.png){width=2199px height=516px}
...
2. Реализовано создание документа «Реализация» в разделе проекта. При создании реализации из проектов автоматически открывается подходящая форма документа.
   ...
   ![](./reliz-1-43-0-6.png){width=955px height=705px}
...
6. Во вкладке «Файлы» добавлено отображение всех присоединенных файлов документов, отраженных на вкладке «Документы» проекта.
   ...
   ![](./reliz-1-43-0-7.png){width=2145px height=538px}
...
1. Добавлена группировка по сотруднику в разрезе статей
   ...
   [image:./reliz-1-43-0-8.png:::0,0,100,100::square,14.1782,46.3252,16.3194,9.3541,,top-left:2134px:555px:center]

   ![](./reliz-1-43-0-9.png){width=2127px height=619px}

2. Добавлена сортировка по ФИО

3. Добавлено распределение суммы строки при группировке по сотруднику

   ![](./reliz-1-43-0-10.png){width=1026px height=685px}

   ![](./reliz-1-43-0-11.png){width=1596px height=502px}

   ![](./reliz-1-43-0-12.png){width=1603px height=496px}

   ![](./reliz-1-43-0-13.png){width=2065px height=163px}

4. Добавлена загрузка данных документа из табличного документа (напр. из Excel)

   ![](./reliz-1-43-0-14.png){width=2136px height=319px}
...
2. В платежном поручении появился блок, который отражает данные Плана и Факт
   ...
   ![](./reliz-1-43-0-15.png){width=756px height=265px}
...
2. Из списка документов убран документ «Возврат от клиента» с типом операции «Возврат от комиссионера»

3. В номенклатуру добавлены реквизиты «Статья ДДС» и «Статья себестоимости». Они находятся в карточке номенклатуры в разделе «Дополнительные реквизиты»

4. Для документов «Отчет о розничных продажах», «Реализация», «Отчет комиссионера» изменены движения:
   ...
   2. Для регистра «Расходы» изменена логика получения статьи себестоимости. Теперь, если заполнена статья себестоимости в номенклатуре, то она и встанет в движения иначе статья из документа
      ...
      1. В варианте отчета P&L: План-Факт добавлен отбор по версии плана
         ...
         ![](./reliz-1-43-0-9.png){width=2134px height=940px}
      ...
      1. Добавлен отбор по физическому лицу
         ...
         [image:./reliz-1-3.png:::0,0,100,100::square,77.8356,74.4817,22.1644,25.5183,,top-left:2143px:777px:center]
      ...
      1. Исправлена ошибка при использовании произвольных колонок
         ...
         ![](./reliz-1-43-0-10.png){width=1150px height=199px}
      ...
      1. При создании операции по кошельку на основании управленческой ведомости, если заполнить физическое лицо, то движения по пройдут только по указанному физическому лицу. Соответственно задолженность по заработной плате закроется только по данному сотруднику.
         ...
         ![](./reliz-1-43-0-11.png){width=2121px height=982px}
      ...
      5. Для Бухгалтерии предприятия. Документ «Отражение зарплаты». Добавлено создание на основании отпуска.
         ...
         ![](./reliz-1-43-0-12.png){width=1888px height=301px}
      ...
      6. Во вкладке «Файлы» добавлено отображение всех присоединенных файлов документов, отраженных на вкладке «Документы» проекта.
         ...
         ![](./reliz-1-43-0-15.png){width=2145px height=538px}
      ...
      1. Добавлена группировка по сотруднику в разрезе статей
         ...
         [image:./reliz-1-43-0-31.png:::0,0,100,100::square,14.1782,46.3252,16.3194,9.3541,,top-left:2134px:555px:center]

         ![](./reliz-1-43-0-32.png){width=2127px height=619px}

      2. Добавлена сортировка по ФИО

      3. Добавлено распределение суммы строки при группировке по сотруднику

         ![](./reliz-1-43-0-33.png){width=1026px height=685px}

         ![](./reliz-1-43-0-34.png){width=1596px height=502px}

         ![](./reliz-1-43-0-35.png){width=1603px height=496px}

         ![](./reliz-1-43-0-36.png){width=2065px height=163px}

      4. Добавлена загрузка данных документа из табличного документа (напр. из Excel)

         ![](./reliz-1-43-0-37.png){width=2136px height=319px}
      ...
      2. В платежном поручении появился блок, который отражает данные Плана и Факт
         ...
         ![](./reliz-1-43-0-38.png){width=756px height=265px}
