...
1. **Регламентные операции**. Для операции «Переоценка валютных средств», если есть проводка Дт 91.02  Кт 60.21 добавлено изменение сумм в регистрах Доходы и Расходы и Взаиморасчеты
