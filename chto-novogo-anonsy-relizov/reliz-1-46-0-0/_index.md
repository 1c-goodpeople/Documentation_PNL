...
![](./reliz-1-46-0-2.png){width=1550px height=616px}
...
1. В отчет «План-факт: общие показатели» добавили возможность выбирать вывод факта: по деньгам или по начислению

2. В отчет «План-факт: общие показатели» добавили возможность очищать факт от НДС

![](./reliz-1-46-0-3.png){width=2109px height=592px}
