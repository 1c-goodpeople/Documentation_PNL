...
-  [**УСТАНОВКА**](./vap/ustanovka/_index). Раздел о том, как установить программу и начать ей пользоваться.
...
-  [**ФУНКЦИОНАЛ P&L** ](./p-l/_index)[--](https://gramax.denvic.ru/extractor_docs/extraktor-1s/menyu-extraktora) Описание продукта по каждому блоку. Основная универсальная инструкция детально объясняет все модули, отвечает на вопросы о назначении и использовании.
