...
-  [**ФУНКЦИОНАЛ P&L**](./p-l/_index) -- Описание продукта по каждому блоку. Основная универсальная инструкция детально объясняет все модули, отвечает на вопросы о назначении и использовании.
