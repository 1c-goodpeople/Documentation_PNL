---
order: 7
title: Автоматическое распределение на основании счетов и платежных поручений
---
...
В документах **«Счет покупателю»** и **«Счет от поставщика»** и **«Платежных поручений»** добавлены специальные реквизиты P&L ( статья, проект, раздел проекта, доп аналитика):
