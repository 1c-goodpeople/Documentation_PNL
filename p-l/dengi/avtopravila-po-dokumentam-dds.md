...
#### 5\. Заполнять без подтверждения

Опция определяет, требуется ли вмешательство пользователя при срабатывании автоправил во время проведения документа.

-  Если **отметка установлена**, система автоматически заполняет реквизиты по текущим правилам в момент проведения, минуя этап подтверждения. Рекомендуется использовать для рутинных операций, где правки не требуются.

-  Если **отметка снята** (режим по умолчанию), при проведении документа будет вызвано информационное диалоговое окно. Оно предложит вам либо применить актуальные правила к этому документу, либо отказаться от автозаполнения, оставив данные без изменений.

   [image:./avtopravila-po-dokumentam-dds-6.png:::0,0,100,100::square,0,88.4393,34.619,11.2717,,top-left:1063px:346px:center]

#### 6\. Заполнить прошлые документы
