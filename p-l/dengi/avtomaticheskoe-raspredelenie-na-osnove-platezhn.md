---
order: 6
title: Автоматическое распределение  на основе платежного календаря
---
...
**Что это дает?** Система теперь будет знать, что при проведении банковской выписки ей нужно искать связь с Платежным Календарем и автоматически подтягивать оттуда реквизиты.
...
2. Убедитесь, что выбран тип операции «Платежное списание» (так как мы описываем расход денежных средств).
