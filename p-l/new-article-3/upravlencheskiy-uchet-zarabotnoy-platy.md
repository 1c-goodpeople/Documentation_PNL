...
#### Шаг 3: Выплаты заработной платы

1. После начисления зарплаты следует выплата официальной части. Этот этап не меняется, бизнес-процесс остается прежним.

   ![](./upravlencheskiy-uchet-zarabotnoy-platy-14.png){width=1159px height=619px}

    

#### **Шаг 4: Формирование выплат через «Управленческую ведомость»**
...
#### **Шаг 5: Использование отчетов для контроля**
