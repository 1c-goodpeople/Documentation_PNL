...
**Определение текущего этапа:** Актуальный этап работы по проекту определяется непосредственно в карточке данного проекта, во вкладке «Этапы» (или «Смета»). Каждый этап имеет атрибут «Выполнено». Текущим считается этап, следующий за последним отмеченным как выполненный.
