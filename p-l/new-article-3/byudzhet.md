...
1. Если необходимо признать тот или иной доход/расход, но ни кассовым, ни методом начисления данная операция еще не отражена.

2. Если необходимо «Распределить» определенную операцию на несколько месяцев/год

3. Распределить бюджет доходов/расходов в рамках проектной деятельности

## Форма документа

[image:./byudzhet.png:::0,0,100,100::square,0.4604,28.2609,32.965,25,,top-left&square,0,0,38.2136,15.7609,,top-left:1086px:184px:center]



1. Для начала необходимо занести доход или расход, выбрав соответствующую строку в табличной части
