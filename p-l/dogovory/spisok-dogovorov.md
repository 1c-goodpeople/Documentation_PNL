...
Список договоров в модуле 1С: P&L можно открыть нажав на раздел **Договоры.** По умолчанию отображаются договоры С Покупателями. Чтобы отобразить иные виды договоров:
...
На список договоров можно установить отборы по следующим параметрам:

-  **Состояние** - отбор по состоянию договора

-  **Контрагент** - отбор по контрагенту договора. Доступен как поиск по наименованию контрагента, так и по ИНН или номеру телефона
...
## Как перейти к связанным документам по текущему договору
