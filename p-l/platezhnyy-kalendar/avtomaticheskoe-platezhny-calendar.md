...
## **2\. Настройка автоматического создания по Доходам**
...
### **2\.1. Настройка для документа «Счёт покупателю»**
...
3. **Дата платежа:** Дата в календаре будет автоматически проставлена из реквизита счёта **«Оплата до»**.
...
3. **Дата платежа:** Рассчитывается на основании даты документа и срока оплаты, указанного в договоре.
