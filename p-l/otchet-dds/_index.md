...
Структура отчета позволяет выбрать ранее созданную [структуру отчета](./struktura-otcheta-dds), сгруппировать статьи движения денежных средств и распределить их по видам деятельности. 

Сформировать отчет по новой структуре можно выбрав в поле “Структура отчета” нужный элемент, после чего нажать на кнопку **Сформировать**.
...
Расшифровать суммы доходов и расходов по документам источникам можно 

:::info:true Цели отчета ДДС
