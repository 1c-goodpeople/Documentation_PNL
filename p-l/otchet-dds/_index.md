...
Расшифровать суммы доходов и расходов по документам источникам можно двойным кликом левой кнопки мыши на саму сумму. Справа от отчета откроется панель со списком документов, являющимися источниками для выбранной ячейки. Список документов для удобства сгруппирован по контрагентам.
