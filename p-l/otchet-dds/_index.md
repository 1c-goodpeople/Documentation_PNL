...
3. [comment:Ew3NU]**Общий денежный поток**[/comment] - сумма поступлений и платежей

4. [comment:5k2C3]**Контроль**[/comment] - подтверждает корректность данных в отчете или указывает на ошибки
