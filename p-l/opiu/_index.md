...
Структура отчета позволяет сгруппировать статьи [comment:BM1P7] и распределить их по видам деятельности.[/comment]
...
Параметры определяют структуру, периодичность и уровень детализации данных. В [comment:BjgFl]отчет[/comment] доступны следующие параметры:
